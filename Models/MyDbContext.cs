...
public partial class MyDbContext : DbContext
{
    ...
    public virtual DbSet<GuideNoteMedium> GuideNoteMedia { get; set; }

    public virtual DbSet<GuideRating> GuideRatings { get; set; }

    public virtual DbSet<ItineraryMedium> ItineraryMedia { get; set; }
    ...
    public virtual DbSet<TourMedium> TourMedia { get; set; }

    public virtual DbSet<TourOperator> TourOperators { get; set; }

    public virtual DbSet<TourOperatorMedium> TourOperatorMedia { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-RET53PB;Database=SEP490_G35;Trusted_Connection=True;Encrypt=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BookingExtraCharge>(entity =>
        {
            ...
            entity.HasIndex(e => e.BookingId, "IX_BookingExtraCharges_BookingId");

            entity.HasIndex(e => e.ExtraChargeId, "IX_BookingExtraCharges_ExtraChargeId");
        ...
        modelBuilder.Entity<GuideNoteMedium>(entity =>
        {
        ...
        modelBuilder.Entity<ItineraryMedium>(entity =>
        {
        ...
        modelBuilder.Entity<TourMedium>(entity =>
        {
        ...
        modelBuilder.Entity<TourOperatorMedium>(entity =>
        {
